...
- Now: Align missing data-testid attributes in UI components (sidebar, layout shell, kanban board/columns, theme toggle, settings, empty/error states, etc.) based on E2E selector expectations.
- Next: Re-run workflow E2E, then full E2E suite; iterate on remaining failures and confirm seed data routes exist.
