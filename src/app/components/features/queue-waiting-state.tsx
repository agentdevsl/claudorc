  ...
  return (
    ...
    >
      ...
      <div className="space-y-1">
        <h3 className="text-sm font-semibold text-fg" data-testid="queue-message">
          Queued for an agent
        </h3>
        <p className="text-xs text-fg-muted">
          Position <span data-testid="queue-position-number">{position}</span> in queue
        </p>
      </div>
      {estimatedWaitMinutes !== undefined && (
        <div className="flex items-center gap-2 text-xs text-fg-muted" data-testid="estimated-wait">
